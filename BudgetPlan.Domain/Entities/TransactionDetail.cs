...
public class TransactionDetail : AuditableEntity
{
	...
	private TransactionDetail(double value, string description, DateOnly transactionDate, Guid transactionCategoryId,
		Guid dataAccessId)
	{
		Value = value;
	...
	public void Update(double value, string description, DateOnly transactionDate)
	{
		Value = value;
		Description = description;
		TransactionDate = transactionDate;
