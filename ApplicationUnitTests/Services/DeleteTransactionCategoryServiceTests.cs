...
public class DeleteTransactionCategoryServiceTests : CommandTestBase
{
    ...
    [Fact]
    public async Task DeleteTransactionCategoryWithMigrationItems_GivenValidParams_ShouldDeleteCategoryAndMigrateDetails()
    {
        // Arrange
        ...
        // Act
        await _deleteTransactionCategoryService.DeleteTransactionCategoryWithMigrationItems(transactionCategoryToDeleteId, transactionCategoryToMigrateId);
        
        // Assert
        var category = await _context.TransactionCategories.FirstOrDefaultAsync(x => x.Id == transactionCategoryToDeleteId);
